        ...
        <div class="flex flex-col md:flex-row items-center gap-12">
            <div class="md:w-1/2">
                ...
                <p class="text-gray-500 leading-relaxed mb-8">
                    <span class="text-green-600">10</span>Captcha is a captcha solver service with high accuracy and budget savings.
                    It recognizes reCAPTCHA, Captcha and other types of CAPTCHAs automatically.
                    The price for the service will always be at least 2 times cheaper than manual recognition services
                ...
                @guest
                    ...
                    <button onclick="Alpine.store('auth').open('login')" class="inline-block text-green-600 font-medium hover:underline">
                        $1 Free Trial
                    </button>
                @else
                    ...
                    @if(!auth()->user()->balance_5d)
                        <a href="{{ url('/tickets/new') }}" class="inline-block text-green-600 font-medium hover:underline">
                            $1 Free Trial
                        </a>
                    @endif
                @endguest
            ...
            <div class="md:w-1/2 flex items-center justify-center">
                <img src="{{ asset('assets/img/var.png') }}" class="w-full max-h-[420px] object-contain" alt="hero image">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded-xl p-6">
                ...
                <p class="text-gray-500 text-sm">The process is fully automated to solve captchas, This is why we guarantee the market's lowest price</p>
            </div>
            <div class="bg-white shadow rounded-xl p-6">
                <i class="las la-clock text-6xl text-green-600"></i>
                <h5 class="font-bold text-gray-900 mt-4 mb-2">Very Fast &amp; Accurate Solving</h5>
                <p class="text-gray-500 text-sm"><span class="text-green-600">10</span>Captcha uses the latest AI technology to automatically recognize captchas, making it up to 30x faster than average.</p>
            </div>
            <div class="bg-white shadow rounded-xl p-6">
                ...
                <p class="text-gray-500 text-sm">Pay-per-captcha. Add minimum $1 and start to automatically recognize all types of captchas with accuracy and speed.</p>
            </div>
            <div class="bg-white shadow rounded-xl p-6">
                <i class="las la-compress-arrows-alt text-6xl text-green-600"></i>
                <h5 class="font-bold text-gray-900 mt-4 mb-2">Compatibility</h5>
                <p class="text-gray-500 text-sm">Our service API is easy to integrate with your favorite software. Register and Implement our API to your software.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="flex flex-col md:flex-row gap-12">
            <div class="md:w-5/12">
                ...
                <p class="text-gray-500 leading-relaxed">
                    ...
                    and Machine Learning. Their mission is to explore the potential of Artificial Intelligence further
            ...
            <div class="md:w-7/12">
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    @foreach([
                        ['img' => '1.png', 'label' => 'Web Testing'],
                        ['img' => '2.png', 'label' => 'Social Media'],
                        ['img' => '3.png', 'label' => 'Data Collection'],
                        ['img' => '4.png', 'label' => 'Market Research'],
                        ['img' => '6.png', 'label' => 'Online Shopping'],
                        ['img' => '7.png', 'label' => 'Online Gaming'],
                        ['img' => '5.png', 'label' => 'Seo'],
                        ['img' => '8.png', 'label' => 'Financial Services'],
                    ] as $useCase)
                    <div class="bg-white shadow rounded-xl text-center py-4 px-2">
                        <img src="{{ asset('assets/img/home/' . $useCase['img']) }}"
                             class="w-16 mx-auto" alt="{{ $useCase['label'] }}">
...
<section id="pricing" class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div style="border-radius:8px;overflow:hidden;border:1px solid #e5e7eb">
            {{-- Header --}}
            <div style="display:grid;grid-template-columns:1fr 160px 160px 160px;background:#22c55e;color:#fff;font-weight:600;font-size:0.92rem;padding:10px 20px">
                <div></div>
            ...
            <div style="display:grid;grid-template-columns:1fr 160px 160px 160px;padding:14px 20px;background:{{ $i % 2 === 0 ? '#fff' : '#f9fafb' }};border-top:1px solid #e5e7eb;align-items:center">
                <div style="display:flex;align-items:center;gap:10px">
                    <img src="{{ $plan->img }}" style="width:28px;height:28px;object-fit:contain" alt="{{ $plan->name }}">
...
<section class="py-12 bg-white text-center">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center items-center gap-4">
            @foreach([
                ['file' => '1.svg', 'alt' => 'We work with Bablo'],
                ['file' => '2.svg', 'alt' => 'We work with GSA'],
                ['file' => '3.svg', 'alt' => 'We work with Key Collector'],
                ['file' => '4.svg', 'alt' => 'We work with Ranker X'],
                ['file' => '5.svg', 'alt' => 'We work with SEO Autopilot'],
                ['file' => '6.svg', 'alt' => 'We work with XseoN'],
            ] as $integration)
            <img src="{{ asset('assets/img/home/' . $integration['file']) }}"
                 alt="{{ $integration['alt'] }}" width="140" height="75" class="grayscale hover:grayscale-0 transition">
            @endforeach
        </div>
