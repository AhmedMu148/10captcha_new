<!doctype html>
<html xmlns="" xmlns:v="" xmlns:o="urn:schemas-microsoft-com:office:office">
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td style="font-size:0px;padding:10px 25px;padding-top:0px;padding-right:0px;padding-bottom:40px;padding-left:0px;word-break:break-word;">
                      <p style="border-top:solid 7px #28A745;font-size:1;margin:0px auto;width:100%;">
                      </p>
                      <!--[if mso | IE]>
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 7px #28A745;font-size:1;margin:0px auto;width:600px;" role="presentation" width="600px"
        >
          <tr>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:110px;">
                                <a href="https://10captcha.com" target="_blank">
                              <img alt="" height="auto" src="https://10captcha.com/assets/img/logo.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110" />
                            </a>
                            </td>
                          </tr>
                        </tbody>
              ...
              <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                      <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                        <p style="margin: 10px 0; text-align: center;">Hi ,{{ $email }} , Thank you for signing up to 10Captcha.&nbsp;</p>
                  ...
                  <tr>
                    <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-bottom:20px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="#28A745" role="presentation" style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#28A745;" valign="middle">
                            <a href="{{ $verificationUrl }}" style="background:#28A745;color:#ffffff;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                      <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                        <p style="margin: 10px 0; text-align: center;">If the link doesn&rsquo;t work, copy this URL into your browser:<br> <a target="_blank" rel="noopener noreferrer" href="{{ $verificationUrl }}" style="color:#28A745">{{ $verificationUrl }}</a></p>
                      ...
                      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                        <tr>
                          <td style="padding:4px;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#28A745;border-radius:6px;width:30;">
                              <tr>
                                <td style="font-size:0;height:30;vertical-align:middle;width:30;">
                                  <a href="https://www.facebook.com/10Captcha" target="_blank">
                                    <img height="30" src="https://10captcha.com/assets/img/facebook.png" style="border-radius:6px;" width="30" />
                                  </a>
                                </td>
                              </tr>
                            </table>
